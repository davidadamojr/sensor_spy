 ...
 */
public class LinearAccTable {
    // A three dimensional vector indicating acceleration along each device axis, not including gravity
    // Database table - all values are in m/s^2
    public static final String TABLE_NAME = "linear_acceleration";
