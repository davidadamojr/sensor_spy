...
public class HumidityTable {
    // Database table - all values are in percents
    public static final String TABLE_NAME = "relative_humidity";
    public static final String COLUMN_ID = "_id";
    public static final String COLUMN_PRESSURE = "air_humidity";
    public static final String COLUMN_TIMESTAMP = "timestamp";
    public static final String COLUMN_UPLOADED = "uploaded";

    // Database creation SQL statement
    private static final String DATABASE_CREATE = "create table " + TABLE_NAME + "(" + COLUMN_ID
            + " integer primary key autoincrement, " + COLUMN_PRESSURE + " text not null, " +
